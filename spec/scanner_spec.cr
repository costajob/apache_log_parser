...
describe ApacheLogParser::Scanner do
  it "should collect results by time range filter" do
    ...
    filters << ApacheLogParser::Filters::TimeRange.new(from: "2016-07-03-04:56:24", to: "2016-07-03-04:56:27")
  ...
  it "should collect results by combining filters" do
    filters = [] of ApacheLogParser::Filters::Base
    filters << ApacheLogParser::Filters::TimeRange.new(from: "2016-07-03-04:56:22", to: "2016-07-03-04:56:27")
